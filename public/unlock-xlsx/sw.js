...
const CACHE_NAME = 'unlock-xlsx-v1';
const RUNTIME_CACHE = 'unlock-xlsx-runtime';

// キャッシュするリソース（静的アセット）
const PRECACHE_URLS = [
  '/unlock-xlsx/',
  '/unlock-xlsx/manifest.json',
  '/unlock-xlsx/icon-192.png',
  '/unlock-xlsx/icon-512.png',
];
...
function isStaticAsset(pathname) {
  ...
  return staticExtensions.some(ext => pathname.endsWith(ext)) || pathname === '/unlock-xlsx/manifest.json';
}
