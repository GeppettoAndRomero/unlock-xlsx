...
export async function registerServiceWorker(): Promise<ServiceWorkerRegistration | null> {
  ...
  try {
    // Service Workerを登録（/unlock-xlsx/sw.js, scope=/unlock-xlsx/）。
    // scope がツールの全 locale ページ（/unlock-xlsx/, /unlock-xlsx/ja/ …）を被覆する。
    const registration = await navigator.serviceWorker.register('/unlock-xlsx/sw.js', {
      scope: '/unlock-xlsx/',
    });
