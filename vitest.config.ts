...
export default defineConfig({
  ...
  test: {
    ...
    coverage: {
      ...
      // Scope to the engine and supporting pure utilities. Service-worker
      // registration and browser download behavior are covered by Playwright.
      include: [
        'src/utils/fileValidation.ts',
        'src/utils/settings.ts',
        'src/utils/appError.ts',
        'src/utils/xlsxUnlockEngine.ts',
      ],
